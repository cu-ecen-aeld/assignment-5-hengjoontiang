...
#define DSS_PRIV_FILENAME "/etc/ssh/ssh_dss_host_key"
#define RSA_PRIV_FILENAME "/etc/ssh/ssh_rsa_host_key"
#define ECDSA_PRIV_FILENAME "/etc/ssh/ssh_ecdsa_host_key"
#define ED25519_PRIV_FILENAME "/etc/ssh/ssh_ed25519_host_key"
...
#define DROPBEAR_DEFAULT_CLI_AUTHKEY ".ssh/id_sshkey"
...
#define DEFAULT_KEEPALIVE_LIMIT 5
